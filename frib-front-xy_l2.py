...
#len(d5_3d_bx_m) -> 151 (x)
#len(d5_3d_bx_m[0]) -> 21 (y)
#len(d5_3d_bx_m[0,0]) -> 301 (z)
...
d5t_zlen = 1.0
d5t_dx = 0.005
d5t_bx = fzeros((d5t_nx,d5t_ny,d5t_nz))
d5t_by = fones((d5t_nx,d5t_ny,d5t_nz))
d5t_bz = fzeros((d5t_nx,d5t_ny,d5t_nz))

d5t_3d_id = addnewbgrddataset(dx=d5t_dx ,dy=d5t_dx ,zlength=d5t_zlen ,bx=d5t_bx, by=d5t_by ,bz=d5t_bz)
"""
...
d5a_xw = 42.0*cm
d5a_yw = 10.0*cm
d5a_zlen = d5a_frng_l*2.0 + d5_tmp_e - d5_tmp_s
d5a_str = d5_tmp_s - d5a_frng_l
d5a_end = d5a_str+d5a_zlen

d5a_nx = 105
d5a_ny = 25
d5a_nz = 500

d5a_dx = d5a_xw/float64(d5a_nx)
